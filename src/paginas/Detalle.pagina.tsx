...
/**
 * Componente de la página de detalle de un personaje.
 * Muestra la información del personaje seleccionado y sus episodios relacionados.
 */
const PaginaDetalle = () => {
    ...
    <div className="container">
      <div className="detalle">
        <div className="detalle-header">
          <img src={personaje.imagen} alt="Imagen del personaje" />
